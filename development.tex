...
This was as it allowed storms of differing lengths to be quantified by their peak rainfall.
...
This model was created by using a 60km resolution global model to impose boundary conditions on a 12km regional model,
    which was then used to impose boundary conditions on the 2.2 km model.

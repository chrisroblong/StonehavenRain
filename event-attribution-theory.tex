...
This can be done by fitting relevant distribution to both the empirical and model data sets and ensuring that the
...
To apply Allen's~\cite{Allen_2003} probabilistic interpretation,
    the model can be used to generate a datasets for the world with and without warming.
...
From these, a probability ratio of $p_1 / p_0$ can be computed,
...
Multivariable calculus is used to find the Maximum Likelihood Esimators.

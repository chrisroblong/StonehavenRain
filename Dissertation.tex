...
This project applies current event attribution techniques for extreme rainfall events,
    finding a probability ratios for the extreme rainfall to be 1.10 (1.06--1.15 90\% CI),
...
\begin{figure}[H]
    ...
    \caption[A bar chart showing the number of events occurring in each year.]{A bar chart showing the number of events,
        that being 10 grid cells taking their maximum summer rainfall value within the same 12-hour period,
...
\begin{figure}[H]
    ...
    \caption[A bar chart showing the number of cells that contribute to events.]{
        ...
        that being having their summer rainfall maxima in the same 12-hour block as at least 9 other cells.

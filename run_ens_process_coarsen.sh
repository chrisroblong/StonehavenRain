...
do echo "Processing $dir"
   ...
   do 
       ...
       echo "./ens_seas_max_coarsen.py  $dir/pr_\*_1hr_\*.nc --region $rgn -o $outdir/coarsen_$coarsen_CPM_pr_seas_max$ens --monitor --verbose --rolling 2 4 8 --range $range --coarsen $coarsen"
